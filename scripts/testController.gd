...
@onready var pitch = $CameraController/pivot
...
var player_physics_material = load("res://assets/player_physics_material.tres")
...
func relative_input():
	...
	input.z -= int(Input.is_action_pressed("move_back"))
